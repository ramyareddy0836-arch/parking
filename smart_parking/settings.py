...
SECRET_KEY = 'django-insecure-+tf4j9)9c2qyhw$^kp7*zr3z7qnvj-32*7y%259m=l90e0lw@m'
...
AUTHENTICATION_BACKENDS = [
    'parking.backends.EmailOrUsernameBackend',
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'parking.validators.PasswordComplexityValidator',
    },
]
